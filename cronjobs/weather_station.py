...
class WeatherDataCronJob(CronJobBase):
    RUN_EVERY_MINS = 1020

    schedule = Schedule(run_every_mins=RUN_EVERY_MINS)
    code = 'weather_station_cron_job'
        ...
        for camera_id, device_id in device_ids.items():
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    print(f'Successfully fetched weather data for camera {camera_id}')
            except requests.RequestException as e:
                print(f'Error fetching weather data for camera {camera_id}: {e}')
